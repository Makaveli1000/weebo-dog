...
// THIS FILE IS AUTOMATICALLY GENERATED BY YOUR BUILD SCRIPT.
...
// Using window.__project_id to clarify it stores the Firebase Project ID.
window.__project_id = '$PROJECT_ID_CLEAN';

// SECURITY WARNING: Re-evaluate if this token truly needs client-side exposure.
// Firebase Auth SDK usually handles session tokens securely without explicit exposure.
...
// Removed window.NETLIFY_FIREBASE_CONFIG as it was redundant.
// Please use window.__firebase_config instead.
