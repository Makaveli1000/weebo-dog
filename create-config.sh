...
API_KEY="${FIREBASE_API_KEY}" # Read from Netlify Env Var
PROJECT_ID="${FIREBASE_PROJECT_ID}" # Read from Netlify Env Var
STORAGE_BUCKET="${FIREBASE_STORAGE_BUCKET}" # Read from Netlify Env Var
MESSAGING_SENDER_ID="${FIREBASE_MESSAGING_SENDER_ID}" # Read from Netlify Env Var
APP_ID="${FIREBASE_APP_ID}" # Read from Netlify Env Var
GEMINI_KEY="${GEMINI_API_KEY}" # Read from Netlify Env Var
# --- END CRITICAL FIX ---
