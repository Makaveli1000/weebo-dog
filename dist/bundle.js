...
var F, M, User, x, O, N, FirestoreError, __PRIVATE_Deferred, __PRIVATE_OAuthToken, __PRIVATE_EmptyAuthCredentialsProvider, __PRIVATE_EmulatorAuthCredentialsProvider, __PRIVATE_FirebaseAuthCredentialsProvider, __PRIVATE_FirstPartyToken, __PRIVATE_FirstPartyAuthCredentialsProvider, AppCheckToken, __PRIVATE_FirebaseAppCheckTokenProvider, __PRIVATE_AutoId, B, BasePath, ResourcePath, L, FieldPath$1, DocumentKey, k, q, Timestamp, SnapshotVersion, Q, FieldIndex, IndexOffset, $, PersistenceTransaction, PersistencePromise, __PRIVATE_ListenSequence, G, z, j, J, Y, X, ie, se, le, Pe, de, me, fe, pe, we, be, ve, xe, Le, $e, je, He, Ye, Ze, Xe, et, nt, SortedMap, SortedMapIterator, LLRBNode, SortedSet, SortedSetIterator, FieldMask, __PRIVATE_Base64DecodeError, ByteString, it, st, ot, _t, at, DatabaseInfo, ut, DatabaseId, ct, lt, ht, Pt, Tt, dt, ObjectValue, MutableDocument, Bound, OrderBy, Filter, FieldFilter, CompositeFilter, __PRIVATE_KeyFieldFilter, __PRIVATE_KeyFieldInFilter, __PRIVATE_KeyFieldNotInFilter, __PRIVATE_ArrayContainsFilter, __PRIVATE_InFilter, __PRIVATE_NotInFilter, __PRIVATE_ArrayContainsAnyFilter, __PRIVATE_TargetImpl, __PRIVATE_QueryImpl, ObjectMap, Et, At, Rt, Vt, mt, TransformOperation, __PRIVATE_ServerTimestampTransform, __PRIVATE_ArrayUnionTransformOperation, __PRIVATE_ArrayRemoveTransformOperation, __PRIVATE_NumericIncrementTransformOperation, FieldTransform, MutationResult, Precondition, Mutation, __PRIVATE_SetMutation, __PRIVATE_PatchMutation, __PRIVATE_DeleteMutation, __PRIVATE_VerifyMutation, MutationBatch, MutationBatchResult, Overlay, ExistenceFilter, ft, gt, pt, yt, BloomFilter, __PRIVATE_BloomFilterError, RemoteEvent, TargetChange, __PRIVATE_DocumentWatchChange, __PRIVATE_ExistenceFilterChange, __PRIVATE_WatchTargetChange, __PRIVATE_TargetState, __PRIVATE_WatchChangeAggregator, wt, St, bt, JsonProtoSerializer, TargetData, __PRIVATE_LocalSerializer, __PRIVATE_FirestoreIndexValueWriter, __PRIVATE_MemoryIndexManager, __PRIVATE_MemoryCollectionParentIndex, Ct, Ft, Mt, LruParams, __PRIVATE_TargetIdGenerator, xt, Ot, __PRIVATE_RollingSequenceNumberBuffer, __PRIVATE_LruScheduler, __PRIVATE_LruGarbageCollectorImpl, RemoteDocumentChangeBuffer, OverlayedDocument, LocalDocumentsView, __PRIVATE_MemoryBundleCache, __PRIVATE_MemoryDocumentOverlayCache, __PRIVATE_MemoryGlobalsCache, __PRIVATE_ReferenceSet, __PRIVATE_DocReference, __PRIVATE_MemoryMutationQueue, __PRIVATE_MemoryRemoteDocumentCacheImpl, __PRIVATE_MemoryRemoteDocumentChangeBuffer, __PRIVATE_MemoryTargetCache, __PRIVATE_MemoryPersistence, __PRIVATE_MemoryTransaction, __PRIVATE_MemoryEagerDelegate, __PRIVATE_MemoryLruDelegate, __PRIVATE_LocalViewChanges, QueryContext, __PRIVATE_QueryEngine, Qt, $t, __PRIVATE_LocalStoreImpl, __PRIVATE_LocalClientState, __PRIVATE_MemorySharedClientState, __PRIVATE_NoopConnectivityMonitor, zt, __PRIVATE_BrowserConnectivityMonitor, jt, Jt, Ht, __PRIVATE_RestConnection, __PRIVATE_StreamBridge, Yt, __PRIVATE_WebChannelConnection, __PRIVATE_ExponentialBackoff, Zt, __PRIVATE_PersistentStream, __PRIVATE_PersistentListenStream, __PRIVATE_PersistentWriteStream, Datastore, __PRIVATE_DatastoreImpl, __PRIVATE_OnlineStateTracker, Xt, __PRIVATE_RemoteStoreImpl, DelayedOperation, DocumentSet, __PRIVATE_DocumentChangeSet, ViewSnapshot, __PRIVATE_QueryListenersInfo, __PRIVATE_EventManagerImpl, en, tn, __PRIVATE_QueryListener, __PRIVATE_AddedLimboDocument, __PRIVATE_RemovedLimboDocument, __PRIVATE_View, nn, __PRIVATE_QueryView, LimboResolution, __PRIVATE_SyncEngineImpl, __PRIVATE_MemoryOfflineComponentProvider, __PRIVATE_LruGcMemoryOfflineComponentProvider, OnlineComponentProvider, __PRIVATE_AsyncObserver, rn, FirestoreClient, sn, on, _n, FirestoreSettingsImpl, Firestore$1, Query, DocumentReference, CollectionReference, an, __PRIVATE_AsyncQueueImpl, Firestore, Bytes, FieldPath, FieldValue, GeoPoint, VectorValue, cn, ParsedSetData, __PRIVATE_ParseContextImpl, __PRIVATE_UserDataReader, __PRIVATE_ServerTimestampFieldValueImpl, ln, DocumentSnapshot$1, QueryDocumentSnapshot$1, AppliableConstraint, QueryConstraint, QueryFieldFilterConstraint, QueryCompositeFilterConstraint, QueryOrderByConstraint, QueryLimitConstraint, AbstractUserDataWriter, SnapshotMetadata, DocumentSnapshot, QueryDocumentSnapshot, QuerySnapshot, __PRIVATE_ExpUserDataWriter;
var init_index_esm20175 = __esm({
  "node_modules/@firebase/firestore/dist/index.esm2017.js"() {
    ...
    x = "11.10.0";
    O = new Logger("@firebase/firestore");
    N = {
    ...
    Y = "mutationQueues";
    X = "mutations";
    ie = "documentMutations";
    se = "remoteDocumentsV14";
    le = "remoteDocumentGlobal";
    Pe = "targets";
    de = "targetDocuments";
    me = "targetGlobal";
    fe = "collectionParents";
    pe = "clientMetadata";
    we = "bundles";
    be = "namedQueries";
    ve = "indexConfiguration";
    xe = "indexState";
    Le = "indexEntries";
    $e = "documentOverlays";
    je = "globals";
    He = [...[...[...[...[Y, X, ie, j, Pe, J, me, de], pe], le], fe], we, be];
    Ye = [...He, $e];
    Ze = [Y, X, ie, se, Pe, J, me, de, pe, le, fe, we, be, $e];
    Xe = Ze;
    et = [...Xe, ve, xe, Le];
    nt = [...et, je];
    ...
    st = "server_timestamp";
    ot = "__type__";
    _t = "__previous_value__";
    at = "__local_write_time__";
    DatabaseInfo = class {
      /**
    ...
    Et = new SortedMap(DocumentKey.comparator);
    At = new SortedMap(DocumentKey.comparator);
    Rt = new SortedMap(DocumentKey.comparator);
    Vt = new SortedSet(DocumentKey.comparator);
    mt = new SortedSet(__PRIVATE_primitiveComparator);
    ...
    pt = null;
    yt = new Integer([4294967295, 4294967295], 0);
...
var DEFAULT_HOST, CONFIG_STORAGE_BUCKET_KEY, DEFAULT_MAX_OPERATION_RETRY_TIME, DEFAULT_MAX_UPLOAD_RETRY_TIME, DEFAULT_MIN_SLEEP_TIME_MILLIS, StorageError, StorageErrorCode, Location, FailRequest, ErrorCode2, NetworkRequest, RequestEndStatus, StringFormat, StringData, DataURLParts, FbsBlob, Mapping, mappings_, RequestInfo, ResumableUploadStatus, RESUMABLE_UPLOAD_CHUNK_SIZE, TaskState, Observer, textFactoryOverride, XhrConnection, XhrTextConnection, UploadTask, Reference, FirebaseStorageImpl, name4, version4, STORAGE_TYPE;
...
var require_app = __commonJS({
  "src/app.js"() {
    ...
    init_index_esm3();
    init_index_esm4();
    var firebaseConfig = window.NETLIFY_FIREBASE_CONFIG || window.__firebase_config || null;
    ...
    var minutesAgo = (ts) => {
      ...
      const mins = Math.max(0, Math.round(diff / 6e4));
      return mins === 0 ? "just now" : `${mins} min ago`;
    };
    var isAdminLike = (profile) => profile?.role === "admin" || profile?.role === "editor";
    ...
    function cacheElements() {
      els = {
        loadingOverlay: $2("loading-overlay"),
        headerAuthBtn: $2("header-auth-btn"),
        accountBtn: $2("account-btn"),
        userStatus: $2("user-status"),
        paywallContent: $2("paywall-content"),
        mainContent: $2("main-content"),
        adminPanel: $2("admin-panel"),
        loginModal: $2("login-modal"),
        accountModal: $2("account-modal"),
        loginForm: $2("login-form"),
        loginEmail: $2("login-email"),
        loginPassword: $2("login-password"),
        loginError: $2("login-error"),
        loginSubmitBtn: $2("login-submit-btn"),
        accountUID: $2("account-uid"),
        accountEmail: $2("account-email"),
        accountRole: $2("account-role"),
        accountPremiumStatus: $2("account-premium-status"),
        accountNickname: $2("account-nickname"),
        accountNewPassword: $2("account-new-password"),
        saveNicknameBtn: $2("save-nickname-btn"),
        updatePasswordBtn: $2("update-password-btn"),
        logoutBtn: $2("logout-btn"),
        addAthleteForm: $2("add-athlete-form"),
        playerName: $2("player-name"),
        playerSport: $2("player-sport"),
        score0: $2("score0"),
        score1: $2("score1"),
        score2: $2("score2"),
        score3: $2("score3"),
        score4: $2("score4"),
        topAthleteDisplay: $2("top-athlete-display"),
        matchGridBody: $2("match-grid-body"),
        chatMessages: $2("chat-messages"),
        chatMessageInput: $2("chat-message-input"),
        sendChatMessageBtn: $2("send-chat-message-btn"),
        latestData: $2("latest-data"),
        dataStream: $2("data-stream"),
        activeUsersList: $2("active-users-list"),
        sportsDataDisplay: $2("sports-data-display"),
        mediaFileInput: $2("media-file-input"),
        lockerUploadBtn: $2("locker-upload-btn"),
        lockerMediaDisplay: $2("locker-media-display"),
        lockerStatusText: $2("locker-status-text"),
        uploadCounterDisplay: $2("upload-counter-display"),
        uploadProgressBar: $2("upload-progress-bar")
      };
    }
    ...
    function ensureAccountModal() {
      if ($2("account-modal")) return;
      const modal = document.createElement("div");
      modal.id = "account-modal";
      modal.className = "hidden fixed inset-0 z-50 flex items-center justify-center bg-black/95 p-4";
      modal.innerHTML = `
  ...
  `;
    ...
    function setUserStatusText() {
      ...
      const nickname = currentUserProfile?.nickname || currentUser.email?.split("@")[0] || "Grid Member";
      ...
      try {
        await setDoc(
          doc(db, "presence", currentUser.uid),
          {
            ...
            nickname: currentUserProfile?.nickname || currentUser.email?.split("@")[0] || "Grid Member",
            online,
    ...
    async function handleAddAthlete(event) {
      ...
      const name5 = els.playerName?.value?.trim();
      ...
      try {
        await addDoc(collection(db, "athletes"), {
          ...
          createdByNickname: currentUserProfile?.nickname || currentUser.email?.split("@")[0] || "Grid Member"
        });
    ...
    `;
      ...
      <td class="p-3 text-right">
        ${currentUser && isAdminLike(currentUserProfile) ? `<button
              ...
              >Delete</button>` : `<span class="text-[10px] uppercase text-gray-600">View</span>`}
      </td>
    `;
    ...
    async function sendChatMessage() {
      ...
      try {
        await addDoc(collection(db, "chatMessages"), {
          uid: currentUser.uid,
          senderNickname: currentUserProfile?.nickname || currentUser.email?.split("@")[0] || "Grid Member",
          text,
      ...
      unsubscribers.chat = onSnapshot(
        ...
        (snapshot) => {
          ...
          snapshot.forEach((d) => {
            ...
            row.innerHTML = `
          <div class="inline-block max-w-[85%] rounded-xl px-3 py-2 ${mine ? "bg-yellow-500 text-black" : "bg-gray-800 text-white"}">
    ...
    function subscribeToPresence() {
      ...
      unsubscribers.presence = onSnapshot(
        ...
        (snapshot) => {
          ...
          if (!active.length) {
            els.activeUsersList.innerHTML = '<li class="text-sm text-gray-500">No active users yet.</li>';
            return;
          }
          active.forEach((user) => {
            const li = document.createElement("li");
            li.className = "flex items-center justify-between rounded-lg bg-black/40 px-3 py-2 text-sm";
            li.innerHTML = `
        ...
        (error) => {
          ...
          if (els.activeUsersList) {
            els.activeUsersList.innerHTML = '<li class="text-sm text-red-500">Failed to load active users.</li>';
          }
        }
      );
    }
    ...
    function subscribeToSportsData() {
      ...
      unsubscribers.sportsData = onSnapshot(
        ...
        (snapshot) => {
          ...
          if (snapshot.empty) {
            els.sportsDataDisplay.innerHTML = '<p class="text-sm text-gray-500">No sports data submitted yet.</p>';
            return;
          }
          snapshot.forEach((d) => {
            const data = d.data();
    ...
    function subscribeToUserMedia() {
      ...
      if (!currentUser) {
        els.lockerMediaDisplay.innerHTML = '<p class="col-span-full text-center text-sm text-gray-500">Log in to view your media.</p>';
      ...
      unsubscribers.media = onSnapshot(
        ...
        (snapshot) => {
          ...
          if (snapshot.empty) {
            els.lockerMediaDisplay.innerHTML = '<p class="col-span-full text-center text-sm text-gray-500">No media uploaded yet.</p>';
          ...
          snapshot.forEach((d) => {
            ...
            item.className = "overflow-hidden rounded-xl border border-gray-800 bg-black/40";
        ...
        (error) => {
          ...
          els.lockerMediaDisplay.innerHTML = '<p class="col-span-full text-center text-sm text-red-500">Failed to load media.</p>';
        }
      );
    }
